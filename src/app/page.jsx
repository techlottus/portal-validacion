            ...
            <div className=" absolute w-full h-full top-0 ">
              <div className="w-full h-full flex align-middle justify-center">
                <div className="flex mobile:flex-col mobile:space-y-2 align-middle items-center justify-center">
                  <div className="flex  w-[660px] mobile:w-full bg-surface-100  px-6 py-4 mobile:py-2 mobile:px-2 space-x-4 mobile:space-x-0 rounded shadow h-fit">
                    <div className="flex items-center mobile:hidden">
                      <span className="material-icons w-6 h-6 text-xl text-surface-400">
                        search
                      </span>
                    </div>
                    <div className="border-r mobile:border-none grow border-surface-300">
                      <input
                        className="appearance-none grow  bg-surface-100 font-texts text-surface-900 rounded py-2 px-4 leading-tight text-lg mobile:text-md focus:outline-none focus:bg-white"
                        type="text"
                  ...
                  <div className="hidden mobile:flex w-full">
                    <button
                      className="text-surface-100 font-bold bg-surface-900 font-texts py-2 px-4 rounded w-full"
                      type="submit"
                    >
                      Buscar
                    </button>
